...
class NavigationNode(Node):
    def __init__(self):
        ...
        self.goal_pose = [
            [0.8619569230079651, 0.007189632393419743, 0.2, 0.0, 0.0, 0.0, 0.0],    # Drop  0
            [2.5518529415130615, 0.01269426941871643, 0.2, 0.0, 0.0, 0.0, -1.57],     # path  2
    ...
    def start_navigation(self):
        for i, pose in enumerate(self.goal_pose):
            ...
            if i in [0,2,3,4,5,6]:  # ถามจุุดที่หนุด
